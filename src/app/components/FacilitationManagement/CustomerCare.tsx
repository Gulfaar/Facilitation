...
const CustomerCare = () => {
  return (
    <div className="relative w-full max-w-[1300px] mx-auto  bg-white  max-md:my-4">
      ...
      {/* Overlay Content */}
      <div className="absolute inset-0 flex items-center  sm:px-8 md:px-12 max-md:px-4 max-md:py-2">
        <div className="flex items-center w-full max-md:flex-col">
          ...
          {/* Right: Agent Image */}
          <div className="mt-4 sm:mt-6 md:mt-0 ml-[-200px]  md:ml-[-600px]  -mb-4 scale-y-[1.0] transform origin-bottom w-full 
          md:w-auto max-md:-mt-12 max-md:ml-0 max-md:-mb-2 max-md:w-3/4 max-md:self-end max-md:mr-6">
            <Image 
              src="/fmcustomercarecover2.png"
              alt="Customer Support Agent"
              width={1900}
              height={340}
              className="max-md:w-full md:mt-[-46px]  max-md:h-auto ml-20"
              priority
            />
          </div>
        </div>
